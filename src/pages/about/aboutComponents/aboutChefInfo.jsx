const bgImg = new URL("../../../media/BG.jpg", import.meta.url);
const chefImg = new URL("../../../media/MaskChef.jpg", import.meta.url);
const forkImg = new URL("../../../media/fork.png", import.meta.url);
const kevinLuoImg = new URL("../../../media/KevinLuo.png", import.meta.url);
const facebookImg = new URL("../../../media/facebook-logo.webp", import.meta.url);
const instagramImg = new URL("../../../media/instagram.png", import.meta.url);
const telegramImg = new URL("../../../media/telegram.png", import.meta.url);
...
function ChefInfo() {
  return (
    <section className="relative">
      ...
      />
      <div className="z-[1] max-w-6-xl mx-4 lg:mx-auto grid grid-cols-2 gap-10">
