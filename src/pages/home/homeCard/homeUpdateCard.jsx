...
function HomeUpdateCard(props) {
  // This card is for HomeCard
  return (
      ...
      <div className="shadow-md bg-projectBg border-2 rounded-t-md border-zinc-700">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex justify-between items-center space-x-6">
            ...
            <button className="px-3 md:px-5 py-1 md:py-2 rounded-sm bg-amber-200 text-zinc-900  font-bold hover:bg-transparent border border-amber-200 hover:text-amber-200 active:bg-amber-200 active:text-zinc-900">
              Read More
            </button>
          </div>
        </div>
