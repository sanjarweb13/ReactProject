...
const glassPicture = new URL("../../../media/glass2.png", import.meta.url);
const boottlePicture = new URL(
  "../../../media/boottleDrinks.jpg",
  import.meta.url
);
const andSignPicture = new URL("../../../media/andsign.png", import.meta.url);
    ...
    <section className="max-w-6xl mx-auto px-4 my-32">
      <div className="max-w-[350px] mx-auto my-10">
        ...
        <div className="grid grid-cols-3 gap-10 my-8 justify-center ">
          <img src={glassPicture} alt="fork" className="w-16 pl-6" />
          <img src={glassPicture} alt="fork" className="w-16 pl-6" />
          <img src={glassPicture} alt="fork" className="w-16 pl-6" />
        </div>
        <p className="text-5xl font-bold text-amber-200 my-10 text-center">
          Weekly Special
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="mt-10 max-w-[358px] mx-auto">
          <p className="text-4xl font-semibold text-orange-100 text-center">
            Wine
            <img
              src={andSignPicture}
              alt="andsign"
