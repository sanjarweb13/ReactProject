...
function BookingComp() {
  return (
    <section className="max-w-6xl mx-4 md:mx-auto bg-zinc-900 border border-amber-200 shadow-lg relative">
        <img src={groupPicture} alt="grouppicture" className="absolute top-10 left-10 w-20 z-[1] "/>
        <img src={groupPicture} alt="grouppicture" className="absolute top-10 right-10 w-20 z-[1] "/>
